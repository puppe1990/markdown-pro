...
Project working rules imported from:
`https://gist.github.com/puppe1990/c952c6d270543d302ab89334910cb10c`
...
- Names: specific and unique. Avoid `data`, `handler`, `Manager`. Prefer names that return fewer than 5 grep hits in the codebase.
...
- Predictable paths: `src/lib/test`, `controller/model/view`, etc.

## Formatting

- Use the language default formatter (`prettier`, `black`, `cargo fmt`, `gofmt`, `rubocop -A`). Don't discuss style beyond that.
