        ...
        <div className="fixed inset-0 z-50">
            ...
            <div className="absolute right-0 top-0 h-full w-full max-w-md bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl shadow-2xl flex flex-col border-l border-gray-200/50 dark:border-gray-700/50 animate-in slide-in-from-right duration-300">
                <div className="flex items-center justify-between px-6 py-5 border-b border-gray-200/60 dark:border-gray-700/60 bg-gradient-to-r from-gray-50/50 to-white dark:from-gray-800/50 dark:to-gray-900">
                    ...
                    <button onClick={onClose} className="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-200 hover:scale-110 active:scale-95 text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100">
                    ...
                    {versions.length > 0 ? (
                        <ul className="divide-y divide-gray-200/60 dark:divide-gray-700/60">
                            {versions.map((version, index) => (
                                <li key={version.timestamp} className="p-5 hover:bg-gray-50/50 dark:hover:bg-gray-800/30 transition-colors duration-150">
                        ...
                        <div className="p-12 text-center">
                            ...
                            <p className="text-gray-500 dark:text-gray-400 font-medium">No versions saved yet.</p>
                            <p className="text-sm text-gray-400 dark:text-gray-500 mt-1">Your document history will appear here.</p>
                        </div>
                    )}
                </div>
            </div>
