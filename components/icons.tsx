...
export const QuoteIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg
        ...
        {...props}
    >
        <path d="M3 21c3 0 7-1 7-8V5c0-1.25-.756-2.017-2-2H4c-1.25 0-2 .75-2 1.972V11c0 1.25.75 2 2 2h1v-2H4v-1c0-.75.25-1 1-1h1c.75 0 1 .25 1 1v1c0 .75-.25 1-1 1H3v2h2v2c0 1.25-.75 2-2 2H2v-1z"></path>
        <path d="M15 21c3 0 7-1 7-8V5c0-1.25-.757-2.017-2-2h-4c-1.25 0-2 .75-2 1.972V11c0 1.25.75 2 2 2h1v-2h-1v-1c0-.75.25-1 1-1h1c.75 0 1 .25 1 1v1c0 .75-.25 1-1 1h-2v2h2v2c0 1.25-.75 2-2 2h-1v-1z"></path>
    </svg>
);
...
export const FileImage = (props: React.SVGProps<SVGSVGElement>) => (
    ...
    >
        ...
        <path d="m20 18-3.09-3.09a2 2 0 0 0-2.82 0L8 21"></path>
    </svg>
);
